...
from database.db import add_user, get_file_by_unique_id, get_user, update_user, record_daily_view, save_file_data
...
async def start_command(client, message):
    ...
    if len(message.command) > 1:
        ...
        # -------- VERIFY CALLBACK (supports verify_xxx) --------
